    ...
    <main className="h-screen flex flex-col items-center justify-start p-24 gap-20">
      ...
      <div className="flex items-center justify-between w-full">
        ...
        <h2 className="text-2xl font-bold font-montserrat text-white">
          How do you want to get your recomendation?
        </h2>
        <div className="flex flex-col items-center justify-center gap-4 pt-10">
          <button className="btn btn-neutral w-60" onClick={() => handleOption(1)}>By personal information</button>
          <button className="btn btn-neutral w-60" onClick={() => handleOption(2)}>By your favorite movie</button>
        </div>
        </div>
